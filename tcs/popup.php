 ...
 <link rel="stylesheet" href="../apps/jqwidgets/styles/jqx.base.css" type="text/css" />
	<link rel="stylesheet" href="../apps/jqwidgets/styles/jqx.ui-sunny.css" type="text/css" />

    <script type="text/javascript" src="../scripts/jquery-1.10.2.min.js"></script>
	<script src="https://ajax.googleapis.com/ajax/libs/angularjs/1.3.15/angular.min.js"></script>
	<script src="http://jqwidgets.com/public/jqwidgets/jqx-all.js"></script>
	<script src="http://jqwidgets.com/public/jqwidgets/jqxangular.js"></script>
    <script type="text/javascript" src="../apps/jqwidgets/jqxcore.js"></script>
    <script type="text/javascript" src="../apps/jqwidgets/jqxdata.js"></script> 
    <script type="text/javascript" src="../apps/jqwidgets/jqxbuttons.js"></script>
    <script type="text/javascript" src="../apps/jqwidgets/jqxscrollbar.js"></script>
    <script type="text/javascript" src="../apps/jqwidgets/jqxmenu.js"></script>
    <script type="text/javascript" src="../apps/jqwidgets/jqxgrid.js"></script>
    <script type="text/javascript" src="../apps/jqwidgets/jqxgrid.pager.js"></script>
    <script type="text/javascript" src="../apps/jqwidgets/jqxgrid.selection.js"></script> 
    <script type="text/javascript" src="../apps/jqwidgets/jqxwindow.js"></script>
	<script type="text/javascript" src="../apps/jqwidgets/jqxlistbox.js"></script>
    <script type="text/javascript" src="../apps/jqwidgets/jqxdropdownlist.js"></script>
	<script type="text/javascript" src="../apps/jqwidgets/jqxgrid.sort.js"></script> 
    <script type="text/javascript" src="../apps/jqwidgets/jqxinput.js"></script>
	<script type="text/javascript" src="../apps/jqwidgets/jqxcalendar.js"></script>
	<script type="text/javascript" src="../apps/jqwidgets/jqxdatetimeinput.js"></script>
    <script type="text/javascript" src="../scripts/gettheme.js"></script>
	<script type="text/javascript" src="../apps/jqwidgets/jqxdragdrop.js"></script>
